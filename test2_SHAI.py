...
# 입력 비디오 파일 설정
input_video_path = "C:\\Users\\dromii\\20240401-송도\\M3C\\150m\\DJI_0070.MP4"
...
# 결과 비디오 저장 설정
output_video_path = "C:\\Users\\dromii\\20240401-송도\\M3C\\150m\\obb_150m.avi"
...
while cap.isOpened():
    ...
    for y in range(0, h, tile_size[1]):
        for x in range(0, w, tile_size[0]):
            results, x_offset, y_offset = process_tile(frame, x, y)
